...
&nbsp;
  emit(event, items, isPlaying) {
    this.eventListeners[event].forEach((cb) =&gt; {
      cb(items.length === 1 ? items[0] : <span class="branch-1 cbranch-no" title="branch not covered" >items,</span> isPlaying);
    });
  }
&nbsp;
  toggle(freeze) {
...
<span class="cstat-no" title="statement not covered" >      this.toggleOff(freeze);</span>
    } else {
      this.toggleOn(freeze);
    }
  }
